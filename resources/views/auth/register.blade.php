     ...
     {{ Form::open(array('url' => route('register'), 'class' => 'form-horizontal form-signin','files' => true)) }}    
        {!! csrf_field() !!}
            ...
            <div class="form-group  {{ $errors->has('id_number') ? 'has-error' : ''}}">
              <label for="id_number" class="cols-sm-2 control-label">ID Number</label>
              <div class="cols-sm-10">
                <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                  {!! Form::text('id_number', null, ['class' => 'form-control','placeholder '=>'Enter your ID number']) !!}
                </div>
            ...
            <div class="form-group  {{ $errors->has('birth') ? 'has-error' : ''}}">
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                  {!! Form::text('birth', null, ['class' => 'form-control','placeholder '=>'Enter your birth']) !!}
                </div>
            ...
            <div class="form-group  {{ $errors->has('gender') ? 'has-error' : ''}}">
              ...
              <div class="cols-sm-10">
                <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                  {!! Form::text('gender', null, ['class' => 'form-control','placeholder '=>'Enter your gender']) !!}
                </div>
